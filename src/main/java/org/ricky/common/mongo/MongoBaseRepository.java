...
import static org.ricky.core.common.exception.ErrorCodeEnum.*;
import static org.ricky.core.common.utils.MapUtils.mapOf;
import static org.ricky.core.common.utils.ValidationUtils.*;
...
public abstract class MongoBaseRepository<AR extends AggregateRoot> {
    ...
    protected final void checkUserShip(AggregateRoot ar, UserContext userContext) {
        ...
        if (!Objects.equals(ar.getUserId(), userContext.getUid())) {

...
import org.ricky.core.common.properties.CommonProperties;
...
import static org.ricky.core.common.exception.ErrorCodeEnum.TOO_MANY_REQUEST;
...
public class RedisRateLimiter implements RateLimiter {
    ...
    private void doApply(String key, int limit, int expire, TimeUnit expireUnit) {
        ...
        if (StringUtils.isNotBlank(count) && Integer.parseInt(count) >= limit) {
            throw new MyException(TOO_MANY_REQUEST, "当前请求量过大。", MapUtils.mapOf("key", finalKey));
        }
